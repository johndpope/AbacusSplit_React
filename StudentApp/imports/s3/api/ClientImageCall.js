...
if(Meteor.isServer){
	...
	Meteor.methods({
	    ...
	    // var link = ProductImage.findOne({_id:fileObjId}).link();
	     ...
	     var linkPath = ProductImage.findOne({_id:fileObjId}).path;
	    // var link = "https://s3.ap-south-1.amazonaws.com/onlineabacus/"+linkPath;   ---------new
		var link = "https://s3.ap-south-1.amazonaws.com/onlineexamabacus/"+linkPath; 
