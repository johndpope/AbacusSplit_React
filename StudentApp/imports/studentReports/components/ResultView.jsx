...
export default class ResultView extends TrackerReact(Component) {
	...
	constructor(){
		...
		this.studWiseTestMonthlyData = this.studWiseTestMonthlyData.bind(this);
	}
...
//------- create pagination for table --------------// 
	...
	render() {
		...
		// console.log("this.state.allCategoryWiseStudent",this.state.allCategoryWiseStudent,this.state.allCategoryWiseStudent.length);
	       return (
	       		<div>
		        ...
		        <div >
		         ...
		         <section className="resultheader">
		           {/* <h1>Competition Result View</h1>*/}
		            <span >
		              <img src="/images/maatslogo.png" className="col-lg-2 col-md-2 col-sm-2 col-xs-2 dashboardLogoOESSmall" />
		            </span>
		            <label className="pull-right lgnbtn">
		              <a title="Click here to login as student" href="/" className="lgnbtncolor">Login</a>
		            </label>
		          </section>
		          {/* Main content */}
		                ...
		                <div className="box">
		                  <div className="box-header with-border boxMinHeight">
		                   <div className="box-header with-border">
					            <h3 className="box-title resultviewtitle">Competition Result View</h3>
					        </div>
													...
													<span className="blocking-span"> 
														<select type="text" name="competitionId" ref="competitionId"  id="competitionId" onClick={this.getCompetitionId.bind(this)} onChange={this.handleChange} className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12 inputText" autoComplete="off" title="Please select Category" required>
															...
															{this.state.allCompetitions.map((competition,index)=>{
																  if(competition.competitionView=="Show"){
										    ...
										    <div id={this.state.allCategoryWiseStudent.length>0?"gridView":"nonebx"} className="col-lg-12 col-md-12 resultViewBox">
										    	<div  className="col-lg-12 col-md-12 col-xs-12 col-sm-12">											  
												    {(this.state.allCategoryWiseStudent)?
														...
														:
														<div className="col-lg-offset-5"><i className="fa fa-spin fa-spinner" aria-hidden="true"></i>&nbsp; &nbsp;Please wait....</div>

														}
													</div>
											    </div>
									    :
									    this.state.loader=='datanotfound'?	
									   	 <div className="col-lg-offset-5"><h3>No record found.</h3></div>
									   	 :
