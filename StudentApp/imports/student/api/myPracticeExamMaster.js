...
// export const MyPracticeExamMaster = new Mongo.Collection('mypracticeexammasters');
...
if(Meteor.isServer){
	...
	Meteor.publish("showAllStudPracticeExamsSingle",function(){
...
'getLastVisitedQuestion':function(id){
	var studentAnserSheet = MyPracticeExamMaster.findOne({"_id":id},{fields:{'lastVisitedQuestion':1,
