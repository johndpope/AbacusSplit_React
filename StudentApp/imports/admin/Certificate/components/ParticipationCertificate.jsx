					                  	 			...
					                  	 			<div>
														...
														<div className="certificateWrappers col-lg-12 col-md-8 col-sm-12 col-xs-12 ">
															<div className="col-lg-12 col-md-12 col-sm-4 col-xs-4 certifywrapper">
																...
																<div className="col-lg-12 col-md-12 col-sm-4 col-xs-4">
																	<span className="certificateName col-lg-10 col-lg-offset-1 col-md-12 col-sm-4 col-xs-4">{this.state.examData.firstName+' '+this.state.examData.middleName+' '+this.state.examData.lastName}</span>
																</div>
