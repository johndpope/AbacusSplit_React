...
import DailyStudentRegistrationForFranchiseReport from './DailyStudentRegistrationForFranchiseReport.jsx';
import WeeklyStudentRegistrationForFranchiseReport from './WeeklyStudentRegistrationForFranchiseReport.jsx';
import MonthlyStudentRegistrationForFranchiseReport from './MonthlyStudentRegistrationForFranchiseReport.jsx';
import AnualStudentRegistrationForFranchiseReport from './AnualStudentRegistrationForFranchiseReport.jsx';
import {Session} from 'meteor/session';

export default class StudentRegistrationForFranchise extends TrackerReact(Component) {
...
{									  <DailyStudentRegistrationForFranchiseReport />
}									</div>
									<div id="weeklyReport" className="tab-pane fade">
									  <WeeklyStudentRegistrationForFranchiseReport />
									</div> */}
									<div id="monthlyReport" className="tab-pane fade">
									  <MonthlyStudentRegistrationForFranchiseReport />
									</div>
									<div id="yearlyReport" className="tab-pane fade">
									  <AnualStudentRegistrationForFranchiseReport />
									</div>
		                        </div>
		                      </div>
		                    </div>
