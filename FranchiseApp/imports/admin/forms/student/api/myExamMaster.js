...
//---------------- report ----------------//
	'getCategoryWiseSWTT':function(categoryName,subCategory,competitionId,startRange,limitRange){
		...
		if(Roles.userIsInRole(Meteor.userId(), ['Admin','superAdmin'])){
			if(categoryName=="all"){
				var allCategoryWiseStudent = MyExamMaster.find({'competitionId':competitionId},{sort:{"totalScore":-1,"examSolvedTime":1},skip:startRange, limit: limitRange,fields:{"totalMarks":1,"StudentId":1,"attemptedQues":1,"competitionName":1,"firstName":1,"lastName":1,"totalQuestion":1,"totalScore":1,"examSolvedTime":1,"status":1,"rank":1}}).fetch();
				if(allCategoryWiseStudent){
					return allCategoryWiseStudent;				
				}
			}else{
				if(subCategory=="all"){
					var allCategoryWiseStudent = MyExamMaster.find({'competitionId':competitionId,'category':categoryName},{sort:{"totalScore":-1,"examSolvedTime":1},skip:startRange, limit: limitRange,fields:{"totalMarks":1,"StudentId":1,"attemptedQues":1,"competitionName":1,"firstName":1,"lastName":1,"totalQuestion":1,"totalScore":1,"examSolvedTime":1,"status":1,"rank":1}}).fetch();
					if(allCategoryWiseStudent){
						return allCategoryWiseStudent;				
					}
				}else{
			...
			if(categoryName=="all"){
				var allCategoryWiseStudent = MyExamMaster.find({'franchise_id':Meteor.userId(),'competitionId':competitionId},{sort:{"totalScore":-1,"examSolvedTime":1},fields:{"totalMarks":1,"StudentId":1,"attemptedQues":1,"competitionName":1,"firstName":1,"lastName":1,"totalQuestion":1,"totalScore":1,"examSolvedTime":1,"status":1,"rank":1}}).fetch();
				if(allCategoryWiseStudent){
					return allCategoryWiseStudent;				
				}
			}else{
	...
	'getAllResult':function(categoryName,subCategory,competitionId,startRange,limitRange){
		// console.log("startRange",startRange);
		// console.log("limitRange",limitRange);
		if(Roles.userIsInRole(Meteor.userId(), ['Admin','superAdmin'])){
			if(categoryName=="all"){
			...
			if(categoryName=="all"){
				var allCategoryWiseStudent = MyExamMaster.find({'competitionId':competitionId},{sort:{"totalScore":-1,"examSolvedTime":1},fields:{"totalMarks":1,"StudentId":1,"attemptedQues":1,"competitionName":1,"firstName":1,"lastName":1,"totalQuestion":1,"totalScore":1,"examSolvedTime":1,"status":1,"rank":1,"category":1,"subCategory":1,"studImg":1}}).fetch();
				if(allCategoryWiseStudent){
					return allCategoryWiseStudent;				
				}
			}else{
		...
		'getAllResultSearch':function(categoryName,studentNameCWTD,compId){
...
// ---------------- search  by Admin-----------------------//
	'getCategoryWiseSWTTSearch':function(categoryName,studentNameCWTD,compId){
		...
		if(Roles.userIsInRole(Meteor.userId(), ['Franchise'])){
			...
			if(categoryName=="all"){
				var allCategoryWiseStudent = MyExamMaster.find({$and:[{'fullName':studentNameCWTD,'competitionId':compId}]},{sort:{"totalMarks":-1,"examSolvedTime":1},fields:{"totalMarks":1,"StudentId":1,"attemptedQues":1,"competitionName":1,"firstName":1,"lastName":1,"totalQuestion":1,"totalScore":1,"examSolvedTime":1,"status":1,"rank":1}}).fetch();
				if(allCategoryWiseStudent){
					return allCategoryWiseStudent;
				}
			}else{
	...
	'getCategoryWiseSWTTFranchise':function(categoryName,subCategory,competitionId,startRange,limitRange){
		console.log("In call--------------");
		// console.log("limitRange",limitRange);
		if(Roles.userIsInRole(Meteor.userId(), ['Admin','superAdmin','Franchise'])){
			if(categoryName=="all"){
				var allCategoryWiseStudent = MyExamMaster.find({'competitionId':competitionId},{sort:{"totalScore":-1,"examSolvedTime":1},skip:startRange, limit: limitRange,fields:{"totalMarks":1,"StudentId":1,"attemptedQues":1,"competitionName":1,"firstName":1,"lastName":1,"totalQuestion":1,"totalScore":1,"examSolvedTime":1,"status":1,"rank":1,"category":1,"subCategory":1,"studImg":1}}).fetch();
				if(allCategoryWiseStudent){
					return allCategoryWiseStudent;				
	...
	'getCategoryWiseSWTTSearchFranchise':function(categoryName,studentNameCWTD,compId){
...
//----------------- participation certificate ----------------//
  	...
  	'competitionWiseParticipationCertificate':function(competitionId,userId){
  		return MyExamMaster.findOne({"competitionId":competitionId,"StudentId":userId});
  	},
