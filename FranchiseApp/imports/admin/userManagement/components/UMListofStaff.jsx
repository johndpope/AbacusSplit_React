...
// import UMUserStaff from './UMUserStaff.jsx';
...
// 							SweetAlert.swal({
// 						            title             : 'Are you sure,Do you want to Delete? You will not be able to recover below users again!',
// 						            html              : userNames,
// 						            type              : 'warning',
...
// 		        }else{
// 		          return Meteor.users.find({"roles":{ $nin: ["superAdmin","Student","Franchise"] } },{sort:{'createdAt':-1}},{sort:{'createdAt':-1}, skip:this.state.startRange, limit: this.state.limitRange});
// 		        }
// 	      	}else{ 
...
// 	      }else{
// 	      	if(!this.state.firstname){
// 	        	return Meteor.users.find({"roles":{ $in: ["admin","Admin","Staff"] } },{sort:{'createdAt':-1},skip:this.state.startRange, limit: this.state.limitRange});
// 	    	}else{
...
// 									<option value="Student" name="roleListDDOption">Student</option>
// 									<option value="Staff" name="roleListDDOption">Staff</option>
// 									{/*<option value="all" name="roleListDDOption">All</option>		*/}
...
// 		                   		<span className="floating-label">Search by Admin / Student name, Email Id, Franchise name</span>
// 	                   		</span>
// 	                    </div>
...
// 									{/*<th className="umHeader col-lg-1 col-md-1 col-sm-1 col-xs-1"> Number of Submembers </th>*/}
...
// 									{ this.usersStaffListData().map( (usersData, index)=>{
// 										return <UMUserStaff key={usersData._id} usersDataValues={usersData} serialNum={index}/>
// 									  }) 
// 									}
// 								</tbody>
// 							</table>
