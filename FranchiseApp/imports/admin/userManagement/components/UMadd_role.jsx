	...
	delRole(event){
	  ...
	  swal({
			  ...
			  closeOnConfirm    : false
				...
				Meteor.call('deleteRole', _id,(error,result)=>{
					if(error){
	...
	render(){
       ...
       return(
				<tr>
					...
					<td> 
						<i className="editrole fa fa-pencil-square-o editTcon editIcon" data-toggle="modal" data-target={`#edit-${this.props.roleDataVales._id}`} ></i>
						...
						<i className= "deleteIcon roleDelete fa fa-trash delIcon detailsCenter" onClick={this.delRole.bind(this)} id={this.props.roleDataVales._id}></i>
					</td>		
				</tr>
	    );
