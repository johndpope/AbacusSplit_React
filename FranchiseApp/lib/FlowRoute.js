...
// const PracticeStartExamPurchased = Loadable({
//   loader: () => import('/imports/admin/forms/exam/PracticeStartExamPurchased.jsx'),
//   loading(){return <div className="col-lg-10 col-lg-offset-2 col-md-10 col-md-offset-2 col-sm-10 col-sm-offset-2 pageLoadingWrap loaderSize"><img className="loaderImageSize" src="/images/loading1.gif" alt="loading"/></div>}
// });
...
const StudWiseTestReportsTabsFranchise = Loadable({
  loader: () => import('/imports/admin/reports/components/studentWiseTest/StudWiseTestReportsTabsFranchise.jsx'),
  loading(){return <div className="col-lg-10 col-lg-offset-2 col-md-10 col-md-offset-2 col-sm-10 col-sm-offset-2 pageLoadingWrap loaderSize"><img className="loaderImageSize" src="/images/loading1.gif" alt="loading"/></div>}
...
FlowRouter.route('/competitionView', {
    action: function(params, queryParams) {
        mount(FranchiseLayouts,{content: (<StudWiseTestReportsTabsFranchise />) });
    }
});
