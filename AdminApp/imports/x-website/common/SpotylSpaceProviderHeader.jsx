...
class SpotylSpaceProviderHeader extends Component{
						  ...
						  <div className="container-fluid">
						    ...
						    <div className="collapse navbar-collapse navBarCollapse" id="myNavbar">
						      <ul className="nav navbar-nav navBarNav">
						        ...
						        <li>
						        	<a className="smoth-scroll" href="/addressList">
						        		My Address List
						        	</a>
						        </li>
						        <li>
						        	<a className="smoth-scroll" href="/parkingPaymentDet">
						        		Payment History
						        	</a>
						        </li> 
						        <li>
...
SpaceProviderHeaderContainer = createContainer((props)=>{
...
}, SpotylSpaceProviderHeader);

export default SpaceProviderHeaderContainer;