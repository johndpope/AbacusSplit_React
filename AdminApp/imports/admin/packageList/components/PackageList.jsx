...
class PackageList extends TrackerReact(Component)  {
  ...
  componentDidMount(){
    ...
    addPackages(event){
        ...
        var packageId = event.target.getAttribute('id');
        Meteor.call('addPackagesPurchase',packageId,FlowRouter.getParam("orderId"),FlowRouter.getParam("studentId"),(err,res)=>{
          if(err){
            console.log("Something went wrong");
          }else{
            var orderId = res;
            ...
            this.setState({
              ...
              FlowRouter.go('/PackageList/'+FlowRouter.getParam("fId")+'/'+FlowRouter.getParam("studentId")+'/'+orderId);
            }
          }
        });
      }
        ...
        Meteor.call("checkPackagesAdded",FlowRouter.getParam('orderId'),(err,res)=>{
          ...
          console.log("res",res);
           ...
           //     this.setState({
              ...
              // })
                  FlowRouter.go("/MyInvoice/"+FlowRouter.getParam("orderId")+'/'+FlowRouter.getParam("fId")+'/'+FlowRouter.getParam("studentId"));
                          ...
                          <div className="box-header with-border boxMinHeight">
                            ...
                            <div className="box-body packageboxbody  examPageWrapbtn">
                              ...
                              Roles.userIsInRole(Meteor.userId(), ['Franchise'])?
                                        ...
                                        :
                                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bypackagebtnWrap">
                                    <button className="btn bypackagebtn" onClick={this.buyPackages.bind(this)}>Confirm Packages</button>
                                  </div>
                                }
  ...
  export default PackageListContainer = withTracker(props=>{
    ...
    const postHandle1 = Meteor.subscribe("LoginInStudent",FlowRouter.getParam('studentId'));
    const LoadingTest = !postHandle1.ready();
    var studentData = StudentMaster.findOne({"studentId":FlowRouter.getParam('studentId')})||{};
