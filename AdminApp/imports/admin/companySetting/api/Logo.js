...
import { S3Details} from '/imports/admin/companySetting/api/S3details.js';
...
if(s3Data){
    ...
    if (process.env.S3) {
        ...
        if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
            ...
            export const LogoFiles = new FilesCollection({
                ...
                onAfterUpload(fileRef) {
                    ...
                    _.each(fileRef.versions, (vRef, version) => {
                        ...
                        const filePath = 'LogoFiles/' + fileRef._id +'.' + fileRef.extension;
                        s3.putObject({
            ...
            const _origRemove = LogoFiles.remove;
            LogoFiles.remove = function(search) {
