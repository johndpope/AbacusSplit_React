...
import DailyCategoryWiseReport from './DailyCategoryWiseReport.jsx';
import WeeklyCategoryWiseReport from './WeeklyCategoryWiseReport.jsx';
import MonthlyCategoryWiseReport from './MonthlyCategoryWiseReport.jsx';
import AnualCategoryWiseReport from './AnualCategoryWiseReport.jsx';
import {Session} from 'meteor/session';

export default class CategoryWiseReportsTabs extends TrackerReact(Component) {
		                ...
		                <div className="box">
		                  <div className="box-header with-border boxMinHeight">
		                    <div className="box-header with-border">
					           	<h3 className="box-title">Category Wise Exam Reports</h3>
					        </div>
