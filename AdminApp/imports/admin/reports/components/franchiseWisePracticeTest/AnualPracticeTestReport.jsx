...
export default class MonthlyPracticeTestReport extends TrackerReact(Component) {
	...
	showTestData(){
		...
		var monthDateFromSess = Session.get("selectedYear");
	  	var monthDateStart = new Date("1/1/" + monthDateFromSess);//Find out first day of month with selectedMonth
	  	var monthDateToSess = new Date (monthDateStart.getFullYear(), 11, 31);
			...
			{Roles.userIsInRole(Meteor.userId(), ['Admin','superAdmin'])?
				...
				<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 selectCatSubCatListt paddingleftzero">
					<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<span className="blocking-span"> 
							<select type="text" onClick={this.getFranchiseId.bind(this)} id="SelectFranchiseIdY" className="form-control subCatTab col-lg-12 col-md-12 col-sm-12 col-xs-12 " onChange={this.handleChange} required>
				...
				<div className="col-lg-6 col-md-6  col-sm-6 col-xs-12 paddingleftzero">
					<div className="col-lg-12  col-md-12 searchboxreport searchlbl1">
				       		<span className="blocking-span">
				           		<input type="text" name="search"  className="col-lg-12 col-sm-12 SearchExam SearchStudentYearlyName inputTextSearch" placeholder="Search Student Name" onInput={this.getMonthlyTextValue.bind(this)} required/>
				...
				<div className="col-lg-4 col-md-4  col-sm-4 col-xs-4 paddingleftzero">
					<div className="col-lg-12 col-md-12 bottommargin searchbxtop">
			       		<span className="blocking-span">
			           		<input type="text" name="search"  className="col-lg-12 col-sm-12 SearchExam SearchStudentYearlyName inputTextSearch" onInput={this.getMonthlyTextValue.bind(this)} required/>
