...
export default class AllCompetitionResult extends TrackerReact(Component) {
	...
	render() {
	       ...
	       return (
			...
			<div className="col-lg-12 col-md-12">
				<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center">Competition Wise Result </div>
				<div>
