...
// export default class ExamPhotoVerification extends TrackerReact(Component) {
...
// 	            <h1 >Competition wise photo verification</h1>
// 	          </section>
// 	          {/* Main content */}
...
// 														<th className="tab-Table">Photos</th>
...
// 														<td className="tab-Table"><img src={allStudent.studImg} className="examCaptureImg"/></td>
