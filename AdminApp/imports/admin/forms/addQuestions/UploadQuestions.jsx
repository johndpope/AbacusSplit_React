...
class UploadQuestions extends TrackerReact(Component)  {
	constructor(props) {
        super(props);
        this.state={
    ...
    componentWillMount(){
  		 Meteor.call("isAuthenticated","MasterData","UploadQuestions",(err,res)=>{
			if(err){
				console.log(err);
			}else{
				if(res==true){
								...
								<div className="col-lg-10 col-lg-offset-1 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 questionFormWrap">
									<div className="col-lg-12 col-md-12 csvDLWrap">
										...
										<div className="bulkuploadInstruction ">
											...
											<div className="bulkuploadIns col-lg-2 col-md-2 col-sm-2">
												<a href="/csv/uploadBulkQuestions.csv" download>
						              		...
						              		<table className="table table-striped">
											    <thead className="tableHeader csvuploadTab">
											        <tr>
											            ...
											            <th className="col-lg-2">Category Name </th>
											            <th className="col-lg-2">Sub Category </th>
									...
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<input type="file" name="uploadCSV" ref="uploadCSV" onChange={this.uploadCSVQuestion.bind(this)} accept=".csv" className="form-control adminBlkUpldQues col-lg-12 col-md-12 col-sm-12 col-xs-12 inputText" required/>
