							...
							<div className="col-lg-12  col-md-12 col-sm-12 col-xs-12 questionCatTab">
								<div className="tabs-animated">
								  <ul className="nav nav-tabs oesNavTabs" role="tablist">
								    <li role="presentation" className="col-lg-3 col-md-3 tabPadding active"><a href="#tab1" id="A" aria-controls="tab1" role="tab" data-toggle="tab">Category {Session.get('Category1')}</a></li>
								    <li role="presentation" className="col-lg-3 col-md-3 tabPadding"><a href="#tab2" id="B" aria-controls="tab2" role="tab" data-toggle="tab">Category {Session.get('Category2')}</a></li>
								    <li role="presentation" className="col-lg-3 col-md-3 tabPadding"><a href="#tab3" id="C" aria-controls="tab3" role="tab" data-toggle="tab">Category {Session.get('Category3')}</a></li>
								    <li role="presentation" className="col-lg-3 col-md-3 tabPadding"><a href="#tab4" id="D" aria-controls="tab4" role="tab" data-toggle="tab">Category {Session.get('Category4')}</a></li>
								  </ul>
								  ...
								  <div className="col-lg-12 col-md-12 tab-content tab-scroll-content">
								    ...
								    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 categoryTable">
					              		<table className="table table-striped formTable tab-Table">
										    ...
										    {this.A_CategoryQuestion() !=0 ?
											    <tbody className="myAllTable">
											    	{this.A_CategoryQuestion().map((category, index)=>{
											    		return <tr key={index}>
											    			<td></td>
										    ...
										    :
										    	<tbody className="OESDataNotAvailable">
									    			<tr> 
									    				<td colSpan="8">"{Session.get('Category1')} Category Questions not added yet <a to="/AddQuestions">click here </a> to add "</td>
									    			</tr>
									    		</tbody>
								    		}
										</table>
								    ...
								    <div role="tabpanel" className="tab-pane fade" id="tab2">
								    	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 categoryTable">
					              		<table className="table table-striped formTable tab-Table">
										    ...
										    {this.B_CategoryQuestion() !=0 ?
											    <tbody className="myAllTable">
											    	{this.B_CategoryQuestion().map((category, index)=>{
											    		return <tr key={index}>
											    			<td></td>
											    			<td>{category.question}</td>
											    			<td>{category.A}</td>
								    ...
								    <div role="tabpanel" className="tab-pane fade" id="tab3">
								    	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 categoryTable">
					              		<table className="table table-striped formTable tab-Table">
										    ...
										    {this.C_CategoryQuestion() !=0 ?
										    <tbody className="myAllTable">
										    	{this.C_CategoryQuestion().map((category, index)=>{
										    		return <tr key={index}>
										    			<td></td>
										    			<td>{category.question}</td>
										    			<td>{category.A}</td>
										    			...
										    			<td>{category.correctAnswer}</td>
										    			<td>
										    				<a to={`/AddQuestions/${category._id}`}>
										    					<i className="fa fa-edit editIcon" title="Edit Question"></i>
										    				</a>	
										    				<i className="fa fa-trash deleteIcon" id={category._id} onClick={this.removeQuestion.bind(this)} title="Delete Question"></i>
										    ...
										    :
										    	<tbody className="OESDataNotAvailable">
									    			<tr> 
									    				<td colSpan="8">" {Session.get('Category3')} Category Questions not added yet <a to="/AddQuestions">click here </a> to add " </td>
									    			</tr>
									    		</tbody>
								    		}
										</table>
								    ...
								    <div role="tabpanel" className="tab-pane fade" id="tab4">
								    	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 categoryTable">
					              		<table className="table table-striped formTable tab-Table">
										    ...
										    {this.D_CategoryQuestion() !=0 ?
											    <tbody className="myAllTable">
											    	{this.D_CategoryQuestion().map((category, index)=>{
											    		return <tr key={index}>
											    			<td></td>
											    			<td>{category.question}</td>
											    			<td>{category.A}</td>
