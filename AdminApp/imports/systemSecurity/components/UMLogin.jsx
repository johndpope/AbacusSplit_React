            ...
            // alert('in login loginWithPassword');
                    if (error) {
                      ...
                      if(Roles.userIsInRole(Meteor.userId(), ['superAdmin'])) {
                        ...
                        swal("Only Admin can login.Please use student URL to login");  
                        document.getElementById("logInBtn").value = 'Login';
                        $('#loginusername').val('');
                        $('#loginPassword').val('');
                        FlowRouter.go('/noAccesssPage');
                        // this.refs.loginusername='';
                     ...
                     //    }
                      // FlowRouter.go('/initial-company-setting/'+Meteor.userId());
                       ...
                       swal("Only Admin can login.Please use franchise URL to login"); 
                       document.getElementById("logInBtn").value = 'Login';
                        $('#loginusername').val('');
                        $('#loginPassword').val('');
                        FlowRouter.go('/noAccesssPage');
       ...
       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 signUpWrapper">
        ...
        <div className="rrnShowHideDiv">
           ...
           <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls">
             <div className="col-lg-5 col-md-6 col-sm-6 hideSignup">
