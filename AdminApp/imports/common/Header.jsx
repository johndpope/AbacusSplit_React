          ...
          <a href="javascript:void(0)" className="logo navbar-fixed-top">
           ...
           {/* <a href="/adminDashboard">
             ...
             {Roles.userIsInRole(Meteor.userId(),['Franchise']) ?
                ...
                :
                Roles.userIsInRole(Meteor.userId(),['admin','superAdmin','Admin']) ?
                <a href="/adminDashboard">
                  <span className="logo-lg">
                      {/*<b>Online Exam System</b>*/}
                      <img src="/images/maatslogo.png" className="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboardLogoOES" />
              ...
              <ul className="nav navbar-nav">
                ...
                <li className="dropdown user user-menu">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    {/* Menu Footer*/}
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 user-footer-login-profile">
                    <li className="user-footer col-lg-6 col-md-6 col-sm-6 col-xs-6">
                     {/* <div className="pull-left ">
                        {this.myProfile()}
                      </div>*/}
                      {Roles.userIsInRole(Meteor.userId(),['Franchise']) ?
                      <div className="pull-left">
                        <a href="javascript:void(0)" title="My Registration" className="btn btn-default btn-flat" id={Meteor.userId()}  onClick={this.myprofileClick.bind(this)}>
                          My Registration
                        </a>
                      </div>
                      :
                      Roles.userIsInRole(Meteor.userId(),['admin','superAdmin','Admin']) ?
                      <a href="/adminDashboard" title="dashboard" className="btn btn-default btn-flat">
                         <div className="pull-left">
                            Dashboard
                        </div>
                      </a>
                      :  
                      Roles.userIsInRole(Meteor.userId(), ['Student']) ?
                      <a href="/Student/Profiles" className="btn btn-default btn-flat">
                        <div className="pull-left ">
                          Dashboard
                        </div>
                      </a>
                    ...
                    <li className="user-footer col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div className="pull-right">
                        <a href="javascript:void(0)" title="Sign out" className="btn btn-default btn-flat" onClick={this.handleClick.bind(this)}>
                          Sign out
                        </a>
                      </div>
                    </li>
